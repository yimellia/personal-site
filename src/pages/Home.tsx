...
const Home: React.FC = () => {
    ...
    return (<div className="bg-white">
        <div className="mt-10 mb-10 mx-16">
            <div className="text-2xl font-serif text-brown">Personal Website</div>
            <hr className="h-0.5 bg-brown mt-4" />
        </div>
        <div className="space-x-10 columns-2">
            ...
            <div className="justify-left">
                ...
                <button className="btn-hollow my-4 py-4 hover:border-2 hover:font-semibold" onClick={ButtonHandler}>GET TO KNOW ME</button>
            </div>
        </div>
    </div>);
}
